    ...
    <form method="GET" action="{{ route(Route::currentRouteName(), ['id' => $link->id, 'from' => $range['from'], 'to' => $range['to']]) }}" class="d-md-flex">
        <div class="input-group input-group-sm">
            ...
            <div class="input-group-append">
                <button type="button" class="btn btn-outline-primary d-flex align-items-center dropdown-toggle dropdown-toggle-split reset-after" data-tooltip="true" title="{{ __('Filters') }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@include('Qrcode::icons.filter', ['class' => 'fill-current width-4 height-4'])&#8203;</button>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-body">
                    @if($remoteUser->can('dataExport', ['App\Models\Link', $remoteUser->plan->features->data_export]) || (Auth::check() && Auth::user()->role == 1))
