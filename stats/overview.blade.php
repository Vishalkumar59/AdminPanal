                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="d-flex align-items-center text-truncate text-success">
                                        <div class="d-flex align-items-center justify-content-center width-4 height-4 {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}"></div>
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            tooltip: {
                                ...
                                titleColor: '{{ (request()->cookie('dark_mode') == 1 ? '#000' : '#FFF') }}',
                                titleMarginBottom: 7,
                                titleFont: {
                                    size: 16,
                                    weight: 'normal'
                                ...
                                bodyColor: '{{ (request()->cookie('dark_mode') == 1 ? '#000' : '#FFF') }}',
                                bodySpacing: 7,
                                bodyFont: {
                                    size: 14
                                },
...
<div class="row m-n2">
        ...
        <div class="card border-0 shadow-sm h-100">
                                        ...
                                        <div class="d-flex text-truncate align-items-center">
                                            @if($referrer->value)
                                                ...
                                                <div class="d-flex text-truncate">
                                                    <div class="text-truncate" dir="ltr">{{ $referrer->value }}</div> <a href="http://{{ $referrer->value }}" target="_blank" rel="nofollow noreferrer noopener" class="text-secondary d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'mr-2' : 'ml-2') }}"></a>
                                                </div>
                                            @else
                                                <div class="d-flex align-items-center {{ (__('lang_dir') == 'rtl' ? 'ml-2' : 'mr-2') }}">
            ...
            @if(count($referrers) > 0)
                <div class="card-footer bg-base-2 border-0">
                    <a href="" class="text-muted font-weight-medium d-flex align-items-center justify-content-center">{{ __('View all') }} </a>
                </div>
            @endif
        </div>
    </div>
                                        ...
                                        <div class="d-flex text-truncate align-items-center">
                                            ...
                                            <div class="text-truncate">
                                                @if(!empty(explode(':', $country->value)[1]))
                                                    <a href="" class="text-body" data-tooltip="true" title="{{ __(explode(':', $country->value)[1]) }}">{{ explode(':', $country->value)[1] }}</a>
                                                @else
                                                    {{ __('Unknown') }}
                                                @endif
                                            </div>
    ...
    <div class="col-12 col-lg-6 p-2">
        <div class="card border-0 shadow-sm h-100">
            ...
            @if(count($browsers) > 0)
                <div class="card-footer bg-base-2 border-0">
                    <a href="" class="text-muted font-weight-medium d-flex align-items-center justify-content-center">{{ __('View all') }} 
                    </a>
                </div>
            @endif
        </div>
