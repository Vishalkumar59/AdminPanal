            ...
            <div class="col-md-12">
                <div class="card rounded shadow">
                    ...
                    <form action="{{route('campaign-option.store')}}" method="POST" class="needs-validation" novalidate>
                        ...
                        <input type="hidden" value="{{$campaignlist->id}}" name="campaign_id" id="campaign_id">
                        <div class="row" id="dynamic">
                                ...
                                <div class="px-4 py-2">
                                    ...
                                    <div class="form-icon position-relative">
                                        <input value="{{old('wp_template_code')}}" type="text" class="form-control "
                                            placeholder="Enter WhatsApp Template Code" name="wp_template_code" required>
                                        <div class="invalid-feedback">
                            ...
                            <div class="col-md-5">
                                <div class="px-4 py-2">
                                    ...
                                    <div class="form-icon position-relative">
                                        <input value="{{old('values')}}" type="text" class="form-control "
                            ...
                            <div class="col-md-1 py-4 fixed_add_btn">
    ...
    <script>
        ...
        $('#add_more').click(function(e) {
            ...
            $('#dynamic').append(
                ...
                '<label class="form-label">Values<span class="text-danger"></span></label>'+
                '<input type="text" class="form-control"  placeholder="Input values" name="values[]" value="" >' +
                '</div>' +
