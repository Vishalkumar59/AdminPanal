...
class Link extends Model
{
    ...
    {
        return $this->hasMany('Modules\Qrcode\Models\Stat')->where('link_id', $this->id)->count();
    }
    ...
    {
        return $this->hasOne('Modules\Qrcode\Models\Space', 'id', 'space_id');
    }
    ...
    {
        return $this->hasOne('Modules\Qrcode\Models\Domain', 'id', 'domain_id');
    }
    ...
    {
        return $this->hasMany('Modules\Qrcode\Models\Stat')->where('link_id', $this->id);
    }
    ...
    public function pixels() {
        return $this->belongsToMany('Modules\Qrcode\Models\Pixel');
    }
