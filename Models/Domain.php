...
class Domain extends Model
{
    ...
    {
        return $this->hasMany('Modules\Qrcode\Models\Link')->where('domain_id', $this->id)->count();
    }
    ...
    {
        return $this->hasMany('Modules\Qrcode\Models\Link')->where('domain_id', $this->id);
    }
    ...
    {
        return config('settings.short_protocol') . 'https://' .$this->name;
    }
}
