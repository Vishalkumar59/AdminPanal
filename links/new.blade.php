                    ...
                    <div class="form-row">
                        <div class="col-12 col-md">
                            ...
                            <div class="multiple-links d-none {{ old('multiple_links') || count(request()->session()->get('toast')) > 1 ? ' d-block' : '' }}">
                                ...
                                @endif
                                <small class="form-text text-muted">{{ __('Shorten up to :count links at once.', ['count' => 10]) }} {{ __('One per line.') }}</small>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="domain" id="i-domain-new" class="custom-select{{ $errors->has('domain') ? ' is-invalid' : '' }}">
                                        @foreach($domains->filter(function ($i) { if ($i->user_id || $i->id == config('settings.short_domain') || Auth::user()->can('globalDomains', ['App\Models\Link', Auth::user()->plan->features->global_domains])) { return $i; } }) as $domain)
                        ...
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        @cannot('spaces', ['App\Models\Link', Auth::user()->plan->features->spaces])
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="space" id="i-space-new" class="custom-select{{ $errors->has('space') ? ' is-invalid' : '' }}" @cannot('spaces', ['App\Models\Link', Auth::user()->plan->features->spaces]) disabled @endcannot>
                        ...
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        @cannot('password', ['App\Models\Link', Auth::user()->plan->features->password])
                                            @if(paymentProcessors())
                                                <a href="{{ route('pricing') }}" data-tooltip="true" title="{{ __('Unlock feature') }}">@include('icons.lock-open', ['class' => 'fill-current text-primary width-4 height-4'])</a>
                                            @endif
                                        @endcannot
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" id="i-password" value="{{ old('password') }}" autocomplete="new-password" @cannot('password', ['App\Models\Link', Auth::user()->plan->features->password]) disabled @endcan>
                                </div>
                        ...
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        @cannot('expiration', ['App\Models\Link', Auth::user()->plan->features->expiration])
                                            @if(paymentProcessors())
                                                <a href="{{ route('pricing') }}" data-tooltip="true" title="{{ __('Unlock feature') }}">@include('icons.lock-open', ['class' => 'fill-current text-primary width-4 height-4'])</a>
                                            @endif
                                        @endcannot
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" name="expiration_date" class="form-control{{ $errors->has('expiration_date') ? ' is-invalid' : '' }}" id="i-expiration-date" placeholder="YYYY-MM-DD" value="{{ old('expiration_date') }}" @cannot('expiration', ['App\Models\Link', Auth::user()->plan->features->expiration]) disabled @endcannot>
                                    <input type="time" name="expiration_time" class="form-control{{ $errors->has('expiration_time') ? ' is-invalid' : '' }}" placeholder="HH:MM" value="{{ old('expiration_time') }}" @cannot('expiration', ['App\Models\Link', Auth::user()->plan->features->expiration]) disabled @endcannot>
                        ...
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" dir="ltr" name="expiration_url" id="i-expiration-url" class="form-control{{ $errors->has('expiration_url') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('expiration_url') }}" @cannot('expiration', ['App\Models\Link', Auth::user()->plan->features->expiration]) disabled @endcannot>
                                    <input type="number" name="expiration_clicks" id="i-expiration-clicks" class="form-control {{ $errors->has('expiration_clicks') ? ' is-invalid' : '' }}" autocapitalize="none" spellcheck="false" value="{{ old('expiration_clicks') }}" @cannot('expiration', ['App\Models\Link', Auth::user()->plan->features->expiration]) disabled @endcannot>
                                    <div class="input-group-append">
                        ...
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                <div class="row no-gutters">
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                @cannot('stats', ['App\Models\Link', Auth::user()->plan->features->stats])
                                                    @if(paymentProcessors())
                                                        <a href="{{ route('pricing') }}" data-tooltip="true" title="{{ __('Unlock feature') }}">@include('icons.lock-open', ['class' => 'fill-current text-primary width-4 height-4'])</a>
                                                    @endif
                                                @endcannot
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="privacy" id="i-privacy" class="custom-select{{ $errors->has('privacy') ? ' is-invalid' : '' }}" @cannot('stats', ['App\Models\Link', Auth::user()->plan->features->stats]) disabled @endcannot>
                        ...
                        <div class="col-12 col-lg-6 px-2">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        @cannot('disabled', ['App\Models\Link', Auth::user()->plan->features->disabled])
                                            @if(paymentProcessors())
                                                <a href="{{ route('pricing') }}" data-tooltip="true" title="{{ __('Unlock feature') }}">@include('icons.lock-open', ['class' => 'fill-current text-primary width-4 height-4'])</a>
                                            @endif
                                        @endcannot
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="disabled" id="i-disabled" class="custom-select{{ $errors->has('disabled') ? ' is-invalid' : '' }}" @cannot('disabled', ['App\Models\Link', Auth::user()->plan->features->disabled]) disabled @endcannot>
                        ...
                        <div class="col-12 px-2">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        @cannot('pixels', ['App\Models\Link', Auth::user()->plan->features->pixels])
                                            @if(paymentProcessors())
                                                <a href="{{ route('pricing') }}" data-tooltip="true" title="{{ __('Unlock feature') }}">@include('icons.lock-open', ['class' => 'fill-current text-primary width-4 height-4'])</a>
                                            @endif
                                        @endcannot
                                ...
                                <select name="pixels[]" id="i-pixels" class="custom-select{{ $errors->has('pixels') ? ' is-invalid' : '' }}" size="{{ (count($pixels) == 0 ? 1 : 3) }}" @cannot('pixels', ['App\Models\Link', Auth::user()->plan->features->pixels]) disabled @endcannot multiple>
                        ...
                        <div class="col-12 px-2">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="country-container" class="tab-pane fade{{ old('target_type') == 1 ? ' show active' : '' }}">
                                    ...
                                    @can('targeting', ['App\Models\Link', Auth::user()->plan->features->targeting])
