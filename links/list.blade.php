        ...
        <div class="row">
            ...
            <div class="col-auto">
                <div class="form-row">
                        ...
                        <form method="GET" action="{{ route('links') }}" class="d-md-flex">
                            <div class="input-group input-group-sm">
                                ...
                                <div class="input-group-append">
                                    <button type="button" class="btn btn-outline-primary d-flex align-items-center dropdown-toggle dropdown-toggle-split reset-after" data-tooltip="true" title="{{ __('Filters') }}" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">&#8203;</button>
                    ...
                    <div class="col-auto">
                        <button type="button" class="btn btn-sm btn-outline-primary d-flex align-items-center" data-toggle="modal" data-target="#export-modal" data-tooltip="true" title="{{ __('Export') }}">&#8203;</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="list-group-item px-0 text-muted">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="form-row">
                                <div class="col">
                                    <button type="button" class="btn btn-sm text-primary d-flex align-items-center invisible">&#8203;</button>
                                </div>
                                <div class="col">
                                    <div class="invisible btn d-flex align-items-center btn-sm text-primary">&#8203;</div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-content border-0 shadow">
            <div class="modal-header">
                ...
                <button type="button" class="close d-flex align-items-center justify-content-center width-12 height-14" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="d-flex align-items-center"></span>
                </button>
            </div>
            <div class="modal-body">
                @can('dataExport', ['App\Models\Link', Auth::user()->plan->features->data_export])
